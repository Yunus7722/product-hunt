            ...
            >
                ...
                <ScrollView style={{ marginTop: 30, marginBottom: 20 }}>
                   ...
                   <View style={styles.DobContainer}>
                    ...
                    <View style={{alignSelf:'flex-start',marginHorizontal:15,marginTop:10}}>
                        <Switch
                        value={switchOn} onValueChange={handleSwitch} color='#fb8500'
                        />
                    </View>
                    ...
                    <View style={styles.DobContainer}>
                        ...
                        />
                        <Feather name="calendar" size={20} color='white' style={styles.termination_icon} onPress={showDatePicker} />
                    </View>
                    <View>
                        <DateTimePicker
                            isVisible={DatePickerVisible}
