        ...
        <View style={styles.container}>
           <View style={styles.header}>
                ...
                <View>
                    ...
                    <Text style={{ color: '#132F3F', marginTop: 0, fontSize: 25, fontWeight: '400' }}>Wage Details</Text>
                </View>
            ...
            >
                <View style={{flexDirection:'row'}}>
                    <Text style={styles.text_footer}>Wage Details (Daily)</Text>
